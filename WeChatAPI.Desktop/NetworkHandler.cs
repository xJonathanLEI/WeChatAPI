/*
 * THIS CLASS IS STILL A MESS!!
 * Ignore this class and look somewhere else for the momoent.
 * I will fix it myself later
 * It's a total mess. I basically copied the code from other projects of mine
 * You just need to know this class handles all HTTP requests
 * xJonathan (xJonathan@outlook.com)
 */
using System;
...
public class NetworkHandler
{
    ...
    public async Task<WebResponse> POSTRequestCore(string URL, string param, bool useCookieContainer = false, List<NameValuePair> headers = null, bool presentUserAgent = false, string referer = null)
    {
    ...
    public async Task<string> POSTRequestCoreAsync(string URL, string param, bool useCookieContainer = false, List<NameValuePair> headers = null, bool presentUserAgent = false, string referer = null)
    {
        using (StreamReader SR = new StreamReader((await POSTRequestCore(URL, param, useCookieContainer, headers, presentUserAgent, referer)).GetResponseStream(), System.Text.Encoding.UTF8))
            return SR.ReadToEnd();
    }

    public async Task<string> POSTRequestAsync(string URL, string param, bool useCookieContainer = false, List<NameValuePair> headers = null, bool presentUserAgent = false, string referer = null)
    {
    ...
    public async Task<Image> POSTRequestAsImageAsync(string URL, string param, bool useCookieContainer = false, List<NameValuePair> headers = null, bool presentUserAgent = false, string referer = null)
    {
        return Image.FromStream((await POSTRequestCore(URL, param, useCookieContainer, headers, presentUserAgent, referer)).GetResponseStream());
    }
